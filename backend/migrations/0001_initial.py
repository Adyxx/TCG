    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script_reference', models.CharField(help_text='Code logic ref name, e.g. `apply_haste_effect`', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Character',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abilities', models.ManyToManyField(blank=True, related_name='cards', to='backend.ability')),
